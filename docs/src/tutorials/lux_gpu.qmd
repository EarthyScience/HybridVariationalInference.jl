---
title: "How to move computations to GPU"
engine: julia
execute:
  echo: true
  output: false
...
```{julia}
#| echo: false
#| # if executing on gpu1-hpc22, use the 5th gpu, because first usually loaded
import CUDA, cuDNN 
if gethostname() == "node-r6-he01.bgc-jena.mpg.de"
  CUDA.device!(4)
end
```
```{julia}
