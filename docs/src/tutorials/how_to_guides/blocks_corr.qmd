---
title: "How to model blocks of indenpendent parameters in correlation matrix"
engine: julia
execute:
  echo: true
  output: false
...
Modelling full correlations among PBM-parameters requires many degrees of
freedom.

To decrease the number of parameters to estimate, HVI allows to decompose the
correlations among site parameters or the correlations among global parameters
into sub-blocks of independent parameters.
