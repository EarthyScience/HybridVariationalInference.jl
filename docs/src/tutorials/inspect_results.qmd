...
_xP_batch = _xP = first(probo.train_dataloader)[2]
_xM = first(probo.train_dataloader)[1]
_xM = probo.train_dataloader.data[1]
_xP = probo.train_dataloader.data[2]
tmp = predict_point_hvi(rng, probo, xM = _xM, xP = _xP)
