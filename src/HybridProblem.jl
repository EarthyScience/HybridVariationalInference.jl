struct HybridProblem <: AbstractHybridProblem
    ...
    function HybridProblem(
        ...
        new(θP, θM, f, g, ϕg, priors, py, transM, transP, cor_ends, get_train_loader)
    end
end
...
function HybridProblem(prob::AbstractHybridProblem; scenario=())
    ...
    HybridProblem(θP, θM, g, ϕg, f, priors, py, transP, transM, get_train_loader, cor_ends)
end
...
function get_hybridproblem_train_dataloader(
    rng::AbstractRNG, prob::HybridProblem; kwargs...)
