...
import ForwardDiff
    ...
    ϕms0vz = CP.g_apply_zygote(ϕg, xM, ζsP, pbm_covar_indices0, g, xMP0)
    ...
    ϕms0z = CP.g_apply_zygote(ϕg, xM, ζsP, nothing, g, xMP0)
    ...
    ϕms2z = CP.g_apply_zygote(ϕg2, xM, ζsP, pbm_covar_indices2, g2, xMP)
...
#     f3 = (x) -> sum(3.0 .* x)
#     g_apply_zygote(ϕg2, xM, ζP, pbm_covar_indices2, g2, xMP)
